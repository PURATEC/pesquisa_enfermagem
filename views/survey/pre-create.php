...
<div class="survey-create">
    ...
    <center>
        <a href="<?= \yii\helpers\Url::to(['create-without', 'personID' => 1]); ?>" class="btn btn-sq-lg btn-primary">
        ...
        <a href="<?= \yii\helpers\Url::to(['create-with', 'personID' => 1]); ?>" class="btn btn-sq-lg btn-success">
