...
<div class="survey-create">
    ...
    <center>
        <a href="<?= \yii\helpers\Url::to(['create-without', 'person_id' => 1]); ?>" class="btn btn-sq-lg btn-primary">
        ...
        <a href="<?= \yii\helpers\Url::to(['create-with', 'person_id' => 1]); ?>" class="btn btn-sq-lg btn-success">
